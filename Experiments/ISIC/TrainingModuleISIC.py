...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        # Classifier network: Not used in this project
        ...
        self.act_fn,
        self.dropout,
        nn.Linear(128, 4), #4= number of classes
        )
...
config = {
    ...
    "sigma":[1,5, 7.5], #std of gaussion: not used in this project
...
historyp = run_experiment(0.05, 0.6 , 1, 0.8, False) 
